...
export class MatchingService extends SquidService {
  ...
  async initializeKnowledgeBase(): Promise<{ success: boolean; message: string }> {
    try {
      ...
      // Add realistic dummy data for testing
      const dummyProjects = [
        {
          contextId: 'sample-001',
          type: 'text' as const,
          title: 'Cloud Infrastructure Modernization',
          text: `The Department of Defense seeks a contractor to modernize legacy infrastructure by migrating applications to AWS cloud services. Requirements include expertise in containerization using Docker and Kubernetes, implementation of CI/CD pipelines, infrastructure as code using Terraform, and experience with microservices architecture. The project involves migrating 50+ applications over 12 months with zero downtime requirements.`,
          metadata: {
            projectId: 'sample-001',
            userId: 'user-dod-001',
            solicitationId: 'SOL-DOD-2024-1234',
            title: 'Cloud Infrastructure Modernization',
            description: 'Migration of legacy applications to AWS cloud platform with zero downtime',
            agency: 'Department of Defense',
            status: 'open',
            badge: 'Critical',
            postedDate: '2024-01-15',
            closingDate: '2024-03-15',
            samLink: 'https://sam.gov/opp/SOL-DOD-2024-1234',
            dibbsLink: 'https://dibbs.gov/projects/sample-001',
            contactEmail: 'procurement@defense.gov',
            isFavorite: true,
            naicsCode: '541511',
            userStatus: 'preparing-bid',
            budget: 2500000,
            timeline: '12 months',
        ...
        {
          contextId: 'sample-002',
          type: 'text' as const,
          title: 'Electronic Health Records System',
          text: `VA Medical Centers require a HIPAA-compliant electronic health records system with React/TypeScript frontend and Node.js backend. Must include patient portal, appointment scheduling, prescription management, telemedicine capabilities, and integration with existing lab systems. Security requirements include end-to-end encryption, audit logging, and role-based access control.`,
          metadata: {
            projectId: 'sample-002',
            userId: 'user-va-002',
            solicitationId: 'SOL-VA-2024-5678',
            title: 'Electronic Health Records System',
            description: 'HIPAA-compliant EHR system with patient portal and telemedicine',
            agency: 'Department of Veterans Affairs',
            status: 'open',
            badge: 'Healthcare',
            postedDate: '2024-01-20',
            closingDate: '2024-04-20',
            samLink: 'https://sam.gov/opp/SOL-VA-2024-5678',
            contactEmail: 'va-procurement@va.gov',
            isFavorite: true,
            naicsCode: '541511',
        ...
        {
          contextId: 'sample-003',
          type: 'text' as const,
          title: 'AI-Powered Fraud Detection System',
          text: `Treasury Department needs machine learning system for detecting financial fraud patterns. Requirements include Python development with TensorFlow/PyTorch, real-time data processing, integration with existing banking systems, and explainable AI capabilities. System must process millions of transactions daily and provide risk scores with reasoning.`,
          metadata: {
            projectId: 'sample-003',
            userId: 'user-treasury-003',
            solicitationId: 'SOL-TREAS-2024-9012',
            title: 'AI-Powered Fraud Detection System',
            description: 'Machine learning system for real-time fraud detection and risk assessment',
            agency: 'Department of Treasury',
            status: 'open',
            badge: 'AI/ML',
            postedDate: '2024-01-25',
            closingDate: '2024-03-25',
            samLink: 'https://sam.gov/opp/SOL-TREAS-2024-9012',
            dibbsLink: 'https://dibbs.gov/projects/sample-003',
            contactEmail: 'tech@treasury.gov',
            isFavorite: false,
            naicsCode: '541519',
        ...
        {
          contextId: 'sample-004',
          type: 'text' as const,
          title: 'Cybersecurity Assessment Platform',
          text: `DHS requires a comprehensive cybersecurity assessment platform for evaluating federal agency security posture. Must include vulnerability scanning, penetration testing tools, compliance checking (NIST, FedRAMP), automated report generation, and dashboard with real-time security metrics. Integration with CISA systems required.`,
          metadata: {
            projectId: 'sample-004',
            userId: 'user-dhs-004',
            solicitationId: 'SOL-DHS-2024-3456',
            title: 'Cybersecurity Assessment Platform',
            description: 'Comprehensive security assessment and compliance platform for federal agencies',
            agency: 'Department of Homeland Security',
            status: 'open',
            badge: 'Security',
            postedDate: '2024-02-01',
            closingDate: '2024-05-01',
            samLink: 'https://sam.gov/opp/SOL-DHS-2024-3456',
            contactEmail: 'cyber@dhs.gov',
            isFavorite: true,
            naicsCode: '541512',
            userStatus: 'preparing-bid',
            budget: 5800000,
        ...
        {
          contextId: 'sample-005',
          type: 'text' as const,
          title: 'Mobile App for National Parks',
          text: `National Park Service seeks mobile app development for iOS and Android. Features include interactive maps, trail information, wildlife guides, virtual tours using AR, offline functionality, and visitor engagement tools. Must support 50+ national parks with multilingual content and accessibility features.`,
          metadata: {
            projectId: 'sample-005',
            userId: 'user-nps-005',
            solicitationId: 'SOL-NPS-2024-7890',
            title: 'Mobile App for National Parks',
            description: 'Cross-platform mobile app with AR features for national parks visitors',
            agency: 'National Park Service',
            status: 'open',
            badge: 'Mobile',
            postedDate: '2024-02-05',
            closingDate: '2024-04-05',
            samLink: 'https://sam.gov/opp/SOL-NPS-2024-7890',
            dibbsLink: 'https://dibbs.gov/projects/sample-005',
            contactEmail: 'digital@nps.gov',
            isFavorite: false,
            naicsCode: '541511',
            userStatus: 'maybe',
            budget: 850000,
            timeline: '8 months',
            addedAt: '2024-02-05T16:45:00Z',
          },
        },
      ];

      // Insert dummy data into knowledge base
      await kb.upsertContexts(dummyProjects);

      return {
        success: true,
        message: 'Knowledge base initialized successfully with sample data',
      };
    } catch (error) {
